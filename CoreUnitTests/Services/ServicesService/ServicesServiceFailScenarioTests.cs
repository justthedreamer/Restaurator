...
public class ServicesServiceFailScenarioTests
{
    [Fact]
    ...
    private readonly IServicesService _servicesService = new Core.Services.ServicesServiceFailScenario(new ServicePolicy());
}